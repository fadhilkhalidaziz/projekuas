...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>UAS</b>Keamanan Data</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url(); ?>dist/img/wisuda g19.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">FADHIL</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url(); ?>dist/img/wisuda g19.jpg" class="img-circle" alt="User Image">

                <p>
                  Admin 4 TI C
                  <small>Semester 7  2023</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="enkripsi"><i class="fa fa-address-card-o"></i> <span>ENKRIPSI</span></a></li>
        <li><a href="dekripsi"><i class="fa fa-address-card-o"></i> <span>DEKRIPSI</span></a></li>
        



	<!-- <li><a href="index.php/enkripsi"><i class="fa fa-address-card-o"></i> <span>Start</span></a></li> -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Enkripsi dan Deskripsi pada Website Menggunakan
Algoritma RSA
          ...
          <div class="box box-info">
            ...
            <form action="" method="post">
              ...
              <div class="box-footer">
                <button type="refresh" class="btn btn-warning">REFRESH</button>
                <button type="submit" name="submit"  value="Simpan" class="btn btn-danger pull-right">PROSES</button>
...
<div class="form-group">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright FADHIL.</strong> All rights
    reserved.
  </footer>
